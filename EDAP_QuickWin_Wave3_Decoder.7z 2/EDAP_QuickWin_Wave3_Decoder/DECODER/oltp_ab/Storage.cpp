...
void RecordDef::AddCol1(long lVal, int iOutput)
{
	char cStr[30];
	long rVal;
	rVal = lVal;
...
void RecordDef::AddCol1(unsigned int lVal, int iOutput)
{
	char cStr[30];
	unsigned int rVal;
	rVal = lVal;
...
void RecordDef::AddCol1(int lVal, int iOutput)
{
	char cStr[30];
	int rVal;
	rVal = lVal;
...
void RecordDef::AddCol164(__int64 lVal, int iOutput)
{
	char cStr[60];
	//sprintf(cStr, "%u", itoa(lVal,cStr);
...
void RecordDef::AddCol1(long lVal, int iDec, int iOutput)
{
	char cStr[20];
	char cTmpl[10];
