...
public:
	...
	void AddCol1(unsigned int lVal, int iOutput);
	void AddCol1(long lVal, int iOutput);
	void AddCol1(int lVal, int iOutput);
	void AddCol1(long lVal, int iDec, int iOutput);
	void AddCol164(unsigned _int64 lVal, int iOutput);
	void AddCol164(_int64 lVal, int iOutput);
