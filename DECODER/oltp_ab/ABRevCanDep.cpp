...
#include "LOGDEF_AB.h"
#include "ABRevCanDep.h"

char * ABRevCanDep::TranslateAction(const Msg *pMsg)
{
	...
	sprintf(m_sRelTime, "%d-%s-%d", r_time->tm_mday, m_sMonths[r_time->tm_mon], 1900+r_time->tm_year);
