...
char* DeSelMap::GetFormula(int m_iFormula, char m_sFormula[15])
{
	switch (m_iFormula)
	{
	case 0:
		sprintf(m_sFormula, "2x1");		break;
	case 1:
		sprintf(m_sFormula, "2x3");		break;
	case 2:
		sprintf(m_sFormula, "3x1");		break;
	case 3:
		sprintf(m_sFormula, "3x3");		break;
	case 4:
		sprintf(m_sFormula, "3x4");		break;
	case 5:
		sprintf(m_sFormula, "3x6");		break;
	case 6:
		sprintf(m_sFormula, "3x7");		break;
	case 7:
		sprintf(m_sFormula, "4x1");		break;
	case 8:
		sprintf(m_sFormula, "4x4");		break;
	case 9:
		sprintf(m_sFormula, "4x5");		break;
	case 10:
		sprintf(m_sFormula, "4x6");		break;
	case 11:
		sprintf(m_sFormula, "4x10");	break;
	case 12:
		sprintf(m_sFormula, "4x11");	break;
	case 13:
		sprintf(m_sFormula, "4x14");	break;
	case 14:
		sprintf(m_sFormula, "4x15");	break;
	case 15:
		sprintf(m_sFormula, "5x1");		break;
	case 16:
		sprintf(m_sFormula, "5x5");		break;
	case 17:
		sprintf(m_sFormula, "5x6");		break;
	case 18:
		sprintf(m_sFormula, "5x10");	break;
	case 19:
		sprintf(m_sFormula, "5x15");	break;
	case 20:
		sprintf(m_sFormula, "5x16");	break;
	case 21:
		sprintf(m_sFormula, "5x20");	break;
	case 22:
		sprintf(m_sFormula, "5x25");	break;
	case 23:
		sprintf(m_sFormula, "5x26");	break;
	case 24:
		sprintf(m_sFormula, "5x30");	break;
	case 25:
		sprintf(m_sFormula, "5x31");	break;
	case 26:
		sprintf(m_sFormula, "6x1");		break;
	case 27:
		sprintf(m_sFormula, "6x6");		break;
	case 28:
		sprintf(m_sFormula, "6x7");		break;
	case 29:
		sprintf(m_sFormula, "6x15");	break;
	case 30:
		sprintf(m_sFormula, "6x20");	break;
	case 31:
		sprintf(m_sFormula, "6x21");	break;
	case 32:
		sprintf(m_sFormula, "6x22");	break;
	case 33:
		sprintf(m_sFormula, "6x35");	break;
	case 34:
		sprintf(m_sFormula, "6x41");	break;
	case 35:
		sprintf(m_sFormula, "6x42");	break;
	case 36:
		sprintf(m_sFormula, "6x50");	break;
	case 37:
		sprintf(m_sFormula, "6x56");	break;
	case 38:
		sprintf(m_sFormula, "6x57");	break;
	case 39:
		sprintf(m_sFormula, "6x62");	break;
	case 40:
		sprintf(m_sFormula, "6x63");	break;
	case 41:
		sprintf(m_sFormula, "7x1");		break;
	case 42:
		sprintf(m_sFormula, "7x7");		break;
	case 43:
		sprintf(m_sFormula, "7x8");		break;
	case 44:
		sprintf(m_sFormula, "7x21");	break;
	case 45:
		sprintf(m_sFormula, "7x28");	break;
	case 46:
		sprintf(m_sFormula, "7x29");	break;
	case 47:
		sprintf(m_sFormula, "7x35");	break;
	case 48:
		sprintf(m_sFormula, "7x56");	break;
	case 49:
		sprintf(m_sFormula, "7x63");	break;
	case 50:
		sprintf(m_sFormula, "7x64");	break;
	case 51:
		sprintf(m_sFormula, "7x70");	break;
	case 52:
		sprintf(m_sFormula, "7x91");	break;
	case 53:
		sprintf(m_sFormula, "7x98");	break;
	case 54:
		sprintf(m_sFormula, "7x99");	break;
	case 55:
		sprintf(m_sFormula, "7x112");	break;
	case 56:
		sprintf(m_sFormula, "7x119");	break;
	case 57:
		sprintf(m_sFormula, "7x120");	break;
	case 58:
		sprintf(m_sFormula, "7x126");	break;
	case 59:
		sprintf(m_sFormula, "7x127");	break;
	case 60:
		sprintf(m_sFormula, "8x1");	break;
	default:
		sprintf(m_sFormula, "Err");		break;
	}
	return(m_sFormula);
}
...
void DeSelMap::GetSel(const struct LOGAB *pMlog, unsigned char m_cType, char bufs[1024]) // bet line output
{
...
void DeSelMap::fmtAup( const struct LOGAB * pMlog, char sels[1024])
{
    unsigned short iwu=0, numofbnkbmp=0;
	unsigned char bettype;

	for (int a=0; a < pMlog->data.bt.rac.tran.bet.d.var.a.evtbu; a++)
	{
		bettype = pMlog->data.bt.rac.tran.bet.d.var.a.sel[a].bettypebu;
		...
		switch (bettype)
		{
			...
			case BETTYP_CWC:
				...
				if (a == 0)
					sprintf(sels, "%d*", pMlog->data.bt.rac.tran.bet.d.var.a.sel[a].racebu);
				else
					sprintf(sels+strlen(sels), "%d*", 
					pMlog->data.bt.rac.tran.bet.d.var.a.sel[a].racebu);
			...
			case BETTYP_FF:
                ...
                if ((pMlog->data.bt.rac.tran.bet.d.var.a.sel[a].ind.bnk1 & 0x01) == 1)
                    numofbnkbmp = 1; 
...
/*
    switch (pMlog->data.bt.rac.tran.bet.d.hdr.bettypebu) // format selection details for diff. pool
    {
        case BETTYP_AWP:
        case BETTYP_AWN:
        case BETTYP_APL:
            // for each event
            for (iwu=0; iwu<pMlog->data.bt.rac.tran.bet.d.var.a.evtbu; iwu++)
            {
                if (iwu == 0)
                    sprintf(sels, "%d*", pMlog->data.bt.rac.tran.bet.d.var.a.sel[iwu].racebu);
                else
                    sprintf(sels+strlen(sels), "%d*", 
                            pMlog->data.bt.rac.tran.bet.d.var.a.sel[iwu].racebu);
        ...
        case BETTYP_AQQP:
            ...
            for (iwu=0; iwu < pMlog->data.bt.rac.tran.bet.d.var.a.evtbu; iwu++)
            {
                ...
                // get number of banker bitmap
                if ((pMlog->data.bt.rac.tran.bet.d.var.a.sel[iwu].ind.bnk1 & 0x01) == 1)
                    numofbnkbmp = 1; 
...
void DeSelMap::fmtMk6( const struct LOGAB * pMlog, unsigned int m_iType, char sels[200])
{
    ...
    if (m_iType == TSN_TYPE_MD)
    {
        ...
        editD(drselb, "99", (LONGLONG)pMlog->data.bt.rac.tran.bet.d.var.lot.var.md.drselbu);
    ...
    if (pMlog->data.bt.rac.tran.bet.d.var.lot.n.gamebu >= LOT_GAME_OEG && 
        pMlog->data.bt.rac.tran.bet.d.var.lot.n.gamebu <= LOT_GAME_OUG)
    {//pMlog->data.bt.rac.tran.bet.d.hdr
        fmtbet_ccg(pMlog->data.bt.rac.tran.bet.d.hdr.bettypebu, pMlog->data.bt.rac.tran.bet.d.var.lot.n.gamebu,
                   pMlog->data.bt.rac.tran.bet.d.var.lot.n.sel.single.pcmbu, &offsetwu, sels);
    }

    if (pMlog->data.bt.rac.tran.bet.d.var.lot.n.gamebu == LOT_GAME_OEG)
    {
        // Format odd-even selections
        fmtbet_oeg(pMlog->data.bt.rac.tran.bet.d.hdr.bettypebu, pMlog->data.bt.rac.tran.bet.d.var.lot.n.sel.single.nbnkbu,
                   pMlog->data.bt.rac.tran.bet.d.var.lot.n.sel.single.bnkmbu, &offsetwu, sels);
    }
    else
    {
        // Single entry
        if ((pMlog->data.bt.rac.tran.bet.d.var.lot.n.multi1 & 0x01) == 0)
        {
            // Format banker bitmap
            if (pMlog->data.bt.rac.tran.bet.d.var.lot.n.sel.single.nbnkbu != 0)
            {
                //
                // modified by david jin
                //
                if (pMlog->data.bt.rac.tran.bet.d.var.lot.n.sel.single.pbasbu != 0
                    && pMlog->data.bt.rac.tran.bet.d.var.lot.n.gamebu == LOT_GAME_EXN)
                {
                ...
                fmtMk6Sln(pwbbasewu, 1, pMlog->data.bt.rac.tran.bet.d.var.lot.n.sel.single.bnkmbu, 
                        &offsetwu, sels);

                // Insert banker symbol '>'
                if (pMlog->data.bt.rac.tran.bet.d.var.lot.n.sel.single.nothbu != 0)
                {
            ...
            if (pMlog->data.bt.rac.tran.bet.d.var.lot.n.sel.single.nothbu != 0)
            {
                fmtMk6Sln(pwbbasewu, 1, pMlog->data.bt.rac.tran.bet.d.var.lot.n.sel.single.othmbu, 
                        &offsetwu, sels); 
            }

            // Insert field symbol if field bet
            if ((pMlog->data.bt.rac.tran.bet.d.var.lot.n.field1 & 0x01) != 0)
            {
            ...
            if (pMlog->data.bt.rac.tran.bet.d.var.lot.n.sel.single.npwbbu != 0)
            {
                // Insert powerball selection set separator '#'
                sels[offsetwu] = BET_PWBSEP_C;
                offsetwu += 1;
                pwbbasewu = pMlog->data.bt.rac.tran.bet.d.var.lot.n.sel.single.pbasbu;
                fmtMk6Sln(pwbbasewu, 1, pMlog->data.bt.rac.tran.bet.d.var.lot.n.sel.single.pcmbu,
                        &offsetwu, sels);
            }
        }
        else        // Multi-entry
        {
            for (iwu=0; iwu<pMlog->data.bt.rac.tran.bet.d.var.lot.n.sel.multi.entbu; iwu++)
            {
                fmtMk6Sln(pwbbasewu, 0, pMlog->data.bt.rac.tran.bet.d.var.lot.n.sel.multi.selbu[iwu],
                        &offsetwu, sels);
        ...
        if (pMlog->data.bt.rac.tran.bet.d.var.lot.var.aon.abaswu  != 0)
        {
            // There are add-on selections
            fmtbet_aon(pMlog->data.bt.rac.tran.bet.d.var.lot.var.aon.aselbu, pMlog->data.bt.rac.tran.bet.d.var.lot.var.aon.abaswu, 
                        &offsetwu, sels);
        }
    }
...
void DeSelMap::fmtNrm(const struct LOGAB *pMlog, char sels[1024])
{
    unsigned short iwu=0, legwu=0;

    sprintf(sels, "%d*", pMlog->data.bt.rac.tran.bet.d.var.es.racebu); // get race number

    switch (pMlog->data.bt.rac.tran.bet.d.hdr.bettypebu) // get selection details for diff. pool
    {
        case BETTYP_WINPLA:
        case BETTYP_WIN:
        case BETTYP_PLA:
        ...
        case BETTYP_TRIO:
        case BETTYP_FF:
            fmtQin(pMlog, pMlog->data.bt.rac.tran.bet.d.var.es.betexbnk.bnkbu[0], 2, 0, false, 0, 
                   sels+strlen(sels));
            break;
        case BETTYP_IWN:
		...
		case BETTYP_TCE:
            fmtExt(pMlog, 3, pMlog->data.bt.rac.tran.bet.d.var.es.betexbnk.bnkbu[0], sels+strlen(sels));
            break;
		case BETTYP_FCT:
			fmtExt(pMlog, 2, pMlog->data.bt.rac.tran.bet.d.var.es.betexbnk.bnkbu[0], sels + strlen(sels));
			break;
        case BETTYP_QTT:
            fmtExt(pMlog, 4, pMlog->data.bt.rac.tran.bet.d.var.es.betexbnk.bnkbu[0], sels+strlen(sels));
            break;
        case BETTYP_DBL:
        case BETTYP_TBL:
        case BETTYP_6UP:
            // get number of legs
           // legwu = pMlog->data.bt.rac.tran.bet.d.hdr.bettypebu;
			if (pMlog->data.bt.rac.tran.bet.d.hdr.bettypebu == BETTYP_DBL)
			{
				legwu = 2;
			}
			else if (pMlog->data.bt.rac.tran.bet.d.hdr.bettypebu == BETTYP_TBL)
			{
				legwu = 3;
			}
			else if (pMlog->data.bt.rac.tran.bet.d.hdr.bettypebu == BETTYP_6UP)
			{
				legwu = 6;
			}
		...
		case BETTYP_TTR:
            ...
            for (iwu=0; iwu<legwu; iwu++)
            {
                fmtQin(pMlog, pMlog->data.bt.rac.tran.bet.d.var.es.betexbnk.bnkbu[iwu], 2, iwu*2, false, 0, 
                       sels+strlen(sels));
                if (iwu < legwu-1)
                    sprintf(sels+strlen(sels), "/"); // field seperator
            }
			...
			{
				sprintf( sels+strlen(sels), "|%d*", pMlog->data.bt.rac.tran.bet.d.var.es.racebu);
				for (iwu=0; iwu<legwu; iwu++)
				{
        ...
        case BETTYP_DTR:
            // get number of legs
            legwu = 2;	//(pMlog->data.bt.rac.tran.bet.d.hdr.bettypebu);
            for (iwu=0; iwu<legwu; iwu++)
            {
                fmtQin(pMlog, pMlog->data.bt.rac.tran.bet.d.var.es.betexbnk.bnkbu[iwu], 2, iwu*2, false, 0, 
                       sels+strlen(sels));
...
void DeSelMap::fmtInd( const struct LOGAB *pMlog, const bool allupt, // true if allup
...

{
    ...
    {
        if ((pMlog->data.bt.rac.tran.bet.d.var.es.ind.fld1 & 0x01) == 1)
        {
            sprintf(sels, "F"); // field indicator
            prtft=true;
        }
        if ((pMlog->data.bt.rac.tran.bet.d.var.es.ind.mul1 & 0x01) == 1)
        {
            if (prtft == false)
    ...
    {
        if ((pMlog->data.bt.rac.tran.bet.d.var.a.sel[idwu].ind.fld1 & 0x01) == 1)
            sprintf(sels, "F"); // field indicator 
        if ((pMlog->data.bt.rac.tran.bet.d.var.a.sel[idwu].ind.mul1 & 0x01) == 1)
            sprintf(sels, "M"); // multiple indicator
    }
}

void DeSelMap::fmtQin( const struct LOGAB *pMlog, const unsigned short numofbnk, // num of bankers
        ...
        else 
        {
            for (iwu=0; iwu<numofbmp; iwu++)
            {
				...
				{	
					...
					if (pMlog->data.bt.rac.tran.bet.d.hdr.bettypebu != BETTYP_IWN)
...
void DeSelMap::fmtQin2( const struct LOGAB *pMlog, const unsigned short numofbnk, // num of bankers
             const unsigned short numofbmp, // num of bitmaps
             const unsigned short bmpposwu, // bitmap position
             const bool allupt, // true if allup
             const unsigned short idwu, // id no. of allup array
...
void DeSelMap::fmtSln( const struct LOGAB *pMlog, const unsigned short bmppos, // bitmap position 
             const bool allupt, // true if allup
             const unsigned short idwu, // id no. for allup array
             char sels[]) // selections
{
    ...
    if (allupt == false) // std+exo bet
    {
        ...
        {
				if ((pMlog->data.bt.rac.tran.bet.d.var.es.sellu[bmppos] & ((__int64)1<<jwu)) != 0)
				{
					iwu++;
					if (iwu == 1)
    ...
    else // allup bet
    {
        for (jwu=1; jwu<=fldwu; jwu++)
        {
            ...
            if ((pMlog->data.bt.rac.tran.bet.d.var.a.sel[idwu].sellu[bmppos] & ((__int64)1<<jwu)) != 0)
            {
                iwu++;
                if (iwu == 1)
                    sprintf(sels, "%d+", jwu);
    ...
    if (pMlog->data.bt.rac.tran.bet.d.hdr.bettypebu != BETTYP_TCE && 
        pMlog->data.bt.rac.tran.bet.d.hdr.bettypebu != BETTYP_QTT &&
		(
			((!allupt) && (pMlog->data.bt.rac.tran.bet.d.hdr.bettypebu != BETTYP_FCT)) ||
			(allupt && pMlog->data.bt.rac.tran.bet.d.var.a.sel[idwu].bettypebu!= BETTYP_FCT)
		)
	)
        sels[strlen(sels)-1] = 0; // cancel last '+' operator
}

void DeSelMap::fmtSln2( const struct LOGAB *pMlog, const unsigned short bmppos, // bitmap position 
             const bool allupt, // true if allup
             const unsigned short idwu, // id no. for allup array
             char sels[]) // selections
{
    ...
    for (jwu=1; jwu<=fldwu; jwu++)
    {
        ...
        if ((pMlog->data.bt.rac.tran.bet.d.var.es.betexbnk.sellu[bmppos] & ((__int64)1<<jwu)) != 0)
        {
            iwu++;
            if (iwu == 1)
                sprintf(sels, "%02d+", jwu);
...
void DeSelMap::fmtExt( const struct LOGAB *pMlog, const unsigned short numofbmp, // number of bitmap
             ...
             char sels[]) // selections
{
    ...
    if (pMlog->data.bt.rac.tran.bet.d.var.es.ind.bnk1 == 0 && pMlog->data.bt.rac.tran.bet.d.var.es.ind.fld1 == 0 &&
        pMlog->data.bt.rac.tran.bet.d.var.es.ind.mbk1 == 0 && pMlog->data.bt.rac.tran.bet.d.var.es.ind.mul1 == 0) 
    {
        for (iwu=0; iwu<numofbmp; iwu++)
        {
            if (iwu == 0)
    ...
    else if ((pMlog->data.bt.rac.tran.bet.d.var.es.ind.mbk1 & 0x01) == 1) // multi-banker bet
    {
        for (iwu=0; iwu<numofbmp; iwu++)
        {
            if (iwu == 0)
    ...
    else if ((pMlog->data.bt.rac.tran.bet.d.var.es.ind.mul1 & 0x01) == 1) // mult bet
    {
        if ((pMlog->data.bt.rac.tran.bet.d.var.es.ind.bnk1 & 0x01) == 0) // multiple bet
        {
            for (iwu=0; iwu<numofbmp; iwu++)
            {
                if (iwu == 0)
    ...
    if ((pMlog->data.bt.rac.tran.bet.d.var.es.ind.bnk1 & 0x01) == 1) // for single/multiple banker
    {
        for (iwu=0; iwu<numofbmp; iwu++) // get num of bnk bitmap
        {
            if (pMlog->data.bt.rac.tran.bet.d.var.es.sellu[iwu] == 0)
                break;
            numofbnkbmp++; 
        }
...
void DeSelMap::fmtExtAup(const struct LOGAB *pMlog, const unsigned short numofbmp, // number of bitmap
	const unsigned short idwu, // id no. of allup array
	char sels[]) // selections
{
	unsigned short iwu = 0, numofbnkbmp = 0;
	...
	// single/single banker TCE/QTT/FCT bet
	if (pMlog->data.bt.rac.tran.bet.d.var.a.sel[idwu].ind.bnk1== 0 && pMlog->data.bt.rac.tran.bet.d.var.a.sel[idwu].ind.fld1 == 0 &&
		pMlog->data.bt.rac.tran.bet.d.var.a.sel[idwu].ind.mbk1 == 0 && pMlog->data.bt.rac.tran.bet.d.var.a.sel[idwu].ind.mul1 == 0)
	{
		for (iwu = 0; iwu<numofbmp; iwu++)
		{
			if (iwu == 0)
	...
	else if ((pMlog->data.bt.rac.tran.bet.d.var.a.sel[idwu].ind.mbk1 & 0x01) == 1) // multi-banker bet
	{
		for (iwu = 0; iwu<numofbmp; iwu++)
		{
			if (iwu == 0)
	...
	else if ((pMlog->data.bt.rac.tran.bet.d.var.a.sel[idwu].ind.mul1 & 0x01) == 1) // mult bet
	{
		if ((pMlog->data.bt.rac.tran.bet.d.var.a.sel[idwu].ind.bnk1 & 0x01) == 0) // multiple bet
		{
			for (iwu = 0; iwu<numofbmp; iwu++)
			{
				if (iwu == 0)
	...
	if ((pMlog->data.bt.rac.tran.bet.d.var.a.sel[idwu].ind.bnk1 & 0x01) == 1) // for single/multiple banker
	{
		for (iwu = 0; iwu<numofbmp; iwu++) // get num of bnk bitmap
		{
			if (pMlog->data.bt.rac.tran.bet.d.var.a.sel[idwu].sellu[iwu] == 0)
				break;
			numofbnkbmp++;
		}
